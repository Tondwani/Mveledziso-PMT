...
public abstract class MveledzisoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static MveledzisoWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(MveledzisoWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<MveledzisoDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<MveledzisoDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<MveledzisoDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<MveledzisoDbContext, Task<T>> func)
    {
        T result;
