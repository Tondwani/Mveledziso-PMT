...
namespace Mveledziso.Migrations
{
    ...
    [Migration("20250513121150_changed the values in the enum")]
    partial class changedthevaluesintheenum
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Mveledziso.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Mveledziso.Domain.Entities.ProjectDuty", b =>
                {
                    b.HasOne("Mveledziso.Domain.Entities.Project", "Project")
                        .WithMany("Duties")
            ...
            modelBuilder.Entity("Mveledziso.Domain.Entities.Timeline", b =>
                {
                    b.HasOne("Mveledziso.Domain.Entities.Project", "Project")
                        .WithOne("Timeline")
                        .HasForeignKey("Mveledziso.Domain.Entities.Timeline", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
