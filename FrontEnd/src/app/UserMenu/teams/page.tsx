...
export default function TeamsPage() {
  ...
  const handleAddMember = async (values: MemberFormValues) => {
    ...
    try {
      ...
      // Modal is intentionally kept open after adding a member, allowing the user to add multiple members
      // or close it manually when they're done
      // setIsMemberModalVisible(false); // Close the modal after success
    } catch (error) {
