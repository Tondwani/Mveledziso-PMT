...
//       const genAI = new GoogleGenerativeAI('AIzaSyAqCcHNoVJWZ3mODBIRs5uiBkedHKVfacY');
...
//       setError(`Failed to analyze project risks: ${err instanceof Error ? err.message : 'Unknown error'}. Please check your internet connection and try again.`);
//     } finally {
//       setLoading(false);
//     }
//   };
